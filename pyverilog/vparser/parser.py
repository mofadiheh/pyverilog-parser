# This file has been modified from the original project.
# Original project: https://github.com/PyHDI/Pyverilog
# Modifications by autodebugger project to add partial support for SystemVerilog
"""
...
class VerilogParser(object):
    ...
    def p_parameterdecl_logic_width(self, p):
        'parameterdecl : PARAMETER LOGIC width param_substitution_list SEMICOLON'
        paramlist = [Parameter(rname, rvalue, p[3], lineno=p.lineno(4))
                     for rname, rvalue in p[4]]
        p[0] = Decl(tuple(paramlist), lineno=p.lineno(1))
        p.set_lineno(0, p.lineno(1))
